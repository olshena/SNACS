...
#' Example hash antibody data
#'
#' The antibody data should be a matrix with hashes in the rows and cells in the columns. The hash antibody value should be a continuous numeric measure.
#'   ...
#'
#' @format ## `hashMat`
...
#'
#' The alternate depth data should be a numeric matrix with SNPs in the rows and cells in the columns. The alternate depth value should be a continuous numeric measure.
#'
#' @format ## `depthAltMat`
#' A matrix with 22 rows and 739 columns:
"depthAltMat"
